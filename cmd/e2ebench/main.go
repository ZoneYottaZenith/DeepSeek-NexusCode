...
func main() {
	flag.Usage = func() {
		fmt.Fprintf(flag.CommandLine.Output(), "e2ebench — NexusCode end-to-end benchmark.\n\n")
	...
	bin := flag.String("bin", "nexuscode", "path to the nexuscode binary")
...
func render(results []result) string {
	...
	fmt.Fprintf(&b, "## 🤖 NexusCode e2e benchmark\n\n")

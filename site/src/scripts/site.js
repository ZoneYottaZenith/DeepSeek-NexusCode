// NexusCode site — vanilla interactions
(function () {
  const motionOK = () =>
  ...
  const desktopAssets = [
    "NexusCode-darwin-universal.dmg",
    "NexusCode-darwin-arm64.zip",
    "NexusCode-darwin-amd64.zip",
    "NexusCode-windows-amd64-installer.exe",
    "NexusCode-windows-arm64-installer.exe",
    "NexusCode-windows-amd64.zip",
    "NexusCode-linux-amd64.deb",
    "NexusCode-linux-amd64.tar.gz",
  ];
  fetch("https://dl.nexuscode.io/latest/latest.json", { cache: "no-cache" })
    ...
    .then((d) => {
      ...
      const desktopBase = "https://dl.nexuscode.io/desktop-v" + v;

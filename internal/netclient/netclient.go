// Package netclient builds HTTP clients and proxy resolvers that share NexusCode's
...
// NewHTTPClient returns an HTTP client with NexusCode proxy settings applied.

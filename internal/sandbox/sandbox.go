...
// and Windows uses NexusCode's bundled native helper: AppContainer for read-only
...
// public commands.
const WindowsHelperCommand = "__nexuscode_windows_sandbox"
...
const windowsSandboxFailureMarkerPrefix = "__nexuscode_windows_sandbox_failure__:"

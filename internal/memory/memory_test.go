...
func TestComposeAppendsAfterBase(t *testing.T) {
	base := "BASE PROMPT"
	set := &Set{Docs: []Source{{Path: "/p/NEXUSCODE.md", Scope: ScopeProject, Body: "Use tabs."}}}
	got := Compose(base, set)
...
func TestDiscoverPrecedenceOrder(t *testing.T) {
	...
	mustWrite(t, filepath.Join(user, "NEXUSCODE.md"), "USER LEVEL")
	mustWrite(t, filepath.Join(proj, "NEXUSCODE.md"), "PROJECT LEVEL")
	mustWrite(t, filepath.Join(proj, "NEXUSCODE.local.md"), "LOCAL LEVEL")
...
func TestImportResolution(t *testing.T) {
	...
	mustWrite(t, filepath.Join(proj, "NEXUSCODE.md"), "Top line\n@shared.md\nBottom line")
...
func TestImportResolutionRejectsEscapes(t *testing.T) {
	...
	mustWrite(t, filepath.Join(proj, "NEXUSCODE.md"), "Top\n@/abs/path.md\n@~/secret.md\n@../secret.md\nBottom")
...
func TestImportCycleDoesNotHang(t *testing.T) {
	...
	mustWrite(t, filepath.Join(proj, "NEXUSCODE.md"), "@a.md")
...
func TestImportDiamondAndCycle(t *testing.T) {
	...
	mustWrite(t, filepath.Join(projCycle, "NEXUSCODE.md"), "@cycle1.md")

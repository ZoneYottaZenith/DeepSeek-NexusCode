...
// $LC_ALL / $NEXUSCODE_LANG. Unknown locales return "" so DetectLanguage falls
...
// TestDetectLanguagePriority verifies override beats env and that NEXUSCODE_LANG
...
func TestDetectLanguagePriority(t *testing.T) {
	...
	t.Setenv("NEXUSCODE_LANG", "en")
	if got := DetectLanguage(""); got != "en" {
		t.Errorf("NEXUSCODE_LANG=en overriding LANG=zh: got %q, want en", got)
	}

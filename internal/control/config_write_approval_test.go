...
func TestManagedConfigWriteApprovalIsFreshHuman(t *testing.T) {
	...
	subject := "write NexusCode config: /home/u/.nexuscode/config.toml"
	...
	if !a.preApprovedForDecision(ManagedConfigWriteApprovalTool, "write NexusCode config: /other/path", true) {

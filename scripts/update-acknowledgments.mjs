...
const repo = '你的仓库/DeepSeek-NexusCode';
const api = `https://api.github.com/repos/${repo}/contributors?per_page=20&anon=1`;
const startMarker = '<!-- NEXUSCODE-top-contributors:start -->';
const endMarker = '<!-- NEXUSCODE-top-contributors:end -->';

const headers = {
  Accept: 'application/vnd.github+json',
  'User-Agent': 'NEXUSCODE-acknowledgments-updater',
};

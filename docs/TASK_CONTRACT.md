...
NexusCode works best when nontrivial work is described as a **task contract**:
...
Some prompt templates call the last section "Checkpoint"; NexusCode documents it

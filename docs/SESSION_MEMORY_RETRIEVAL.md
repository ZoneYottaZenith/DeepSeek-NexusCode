...
- Keep NexusCode cache-first: stable prompt bytes stay stable across turns, while
...
NexusCode treats saved memory as a synthesis cache rather than as a raw transcript
cache.

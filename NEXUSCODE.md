...
agent. It is the NexusCode analog of Claude Code's CLAUDE.md.
...
- Hierarchical docs: `NEXUSCODE.md` (this file, committed/shared), `NEXUSCODE.local.md`
  (personal, git-ignored), user-global `~/.config/nexuscode/NEXUSCODE.md`, and any
  `NEXUSCODE.md` in an ancestor dir. `AGENTS.md` is accepted as a fallback name.

...
function registryBindings(env: Env): RegistryBindings {
  return {
    ...
    ACCOUNTS_ORIGIN: env.ID_ORIGIN ?? "https://id.nexuscode.io",
    APP_ORIGIN: env.APP_ORIGIN ?? "https://nexuscode.io",
    ALLOWED_ORIGINS: env.ALLOWED_ORIGINS ?? "https://nexuscode.io,https://www.nexuscode.io",
  };
}
...
export default {
  async fetch(request: Request, env: Env): Promise<Response> {
    ...
    // Authentication moved to id.nexuscode.io; these paths just bounce there.

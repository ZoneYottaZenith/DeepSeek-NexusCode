const R2_BASE = "https://dl.nexuscode.io";
const GITHUB_RELEASES_API = "https://api.github.com/repos/ZoneYottaZenith/DeepSeek-NexusCode/releases?per_page=30";
...
function gatewayHeaders(source: string): HeadersInit {
  return {
    ...
    "x-nexuscode-release-source": source,
  };
}
  ...
  try {
    const res = await fetch(url, {
      headers: {
        ...
        "user-agent": "nexuscode-release-gateway",
      },
    });

...
<header><a class="brand" href="https://nexuscode.io">${LOGO}</a><a class="brand" href="https://nexuscode.io">NexusCode</a><span class="crumb">/ ${esc(crumb)}</span>${LANG_SWITCH}${nav ? `<span class="nav">${nav}</span>` : ""}</header>

-- Unify dashboard auth onto id.nexuscode.io: dashboard access is now a per-email
...
-- Apply: wrangler d1 execute nexuscode-crash --remote --file=migrate-access.sql
...
-- admins/viewers keep their access when they next sign in via id.nexuscode.io.

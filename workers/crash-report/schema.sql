-- Apply: wrangler d1 execute nexuscode-crash --remote --file=schema.sql
...
-- Legacy local auth — superseded by id.nexuscode.io identity + the `access`
...
-- password, verification) lives in id.nexuscode.io; this only maps email → role.

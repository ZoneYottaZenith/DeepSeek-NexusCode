-- NEXUSCODE Community forum. Identity comes from id.nexuscode.io; this DB holds
-- forum content plus the anti-abuse state (trust levels, flags, silences).
-- Apply: wrangler d1 execute nexuscode-forum --remote --file=schema.sql
...
CREATE TABLE IF NOT EXISTS members (
  email          TEXT PRIMARY KEY,              -- lowercased id.nexuscode.io identity
